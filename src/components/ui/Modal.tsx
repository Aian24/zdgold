...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      <div
        className={clsx(
          'relative w-full rounded-3xl border border-gold-500/40 bg-white p-6 md:p-8 shadow-2xl z-10 max-h-[90vh] overflow-y-auto text-neutral-900',
          maxWidthStyles[maxWidth]
        )}
      >
        <div className="flex items-start justify-between pb-4 border-b border-neutral-100 mb-6">
          <div>
            <h3 className="text-xl font-bold text-neutral-900 font-serif tracking-wide">{title}</h3>
